...
## 2026-05-02 Left-to-Right Strengthening

- 继续加强 `running` 行的进行态，让流光在正常对话节奏下也能被稳定感知
- 将主运动方向明确调整为从左往右，避免现有效果方向感不清或接近原地呼吸
- 流光主体改为更接近 Codex 的多层透明高光推进，而不是单块色片横扫

## 2026-05-02 Direction Correction

- 修正当前高光纹理虽然在运动，但观感仍偏向“从右往左”的问题
- 将高光重构为更亮的右侧亮头加左侧长尾，让推进方向稳定读作从左往右
- 继续提高亮度与尾迹长度，让运行中的 live step 在浅色背景下也足够清晰
