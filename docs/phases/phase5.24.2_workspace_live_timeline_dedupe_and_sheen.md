...
## 2026-05-02 Perceived Direction Fix

- 记录本轮问题核心不是缺少位移，而是高光纹理过于对称，导致运动轨迹虽然向右，观感仍容易被读成从右往左
- 下一轮实现以“左侧长尾 + 右侧亮头”的非对称渐变为主，并让峰值亮度出现在亮头穿过卡片中后段时
- 底层 veil 同步改成左到右的轻量漂移，只负责铺底与强化方向感，不与主高光争抢视觉中心
